...
export default function TextPrivacy() {
  return (
    <TextPrivacyStyle>
      Ao tocar em Finalizar cadastro você concorda com nossos{" "}
      <BoldTextPrivacyStyle>Termos de Uso </BoldTextPrivacyStyle>e{" "}
      <BoldTextPrivacyStyle>Política de Privacidade</BoldTextPrivacyStyle>.
    </TextPrivacyStyle>
  );
}
