...
import ButtonPrimaryDefault from "../utils/ButtonPrimaryDefault";

interface ModalOptionsRegisterHomePrps {
...
export default function ModalOptionsRegisterHome({
  modalizeRef,
  title,
  subtitle,
  textButton,
  buttonAction,
}: ModalOptionsRegisterHomePrps) {
